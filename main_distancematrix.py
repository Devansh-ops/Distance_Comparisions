...
class DistanceComparator:
    ...
    def get_distance_distancematrix(self, start_long, start_lat, end_long, end_lat):
        url = f'https://api.distancematrix.ai/maps/api/distancematrix/json?origins={start_lat},{start_long}&destinations={end_lat},{end_long}&key={self.distancematrix_api_key}'
